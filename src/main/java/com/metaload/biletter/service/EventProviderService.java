...
import com.metaload.biletter.dto.event.*;
...
public class EventProviderService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EventProviderService.class);

    private final WebClient webClient;
    private final ExternalServiceConfig config;

    public EventProviderService(WebClient.Builder webClientBuilder, ExternalServiceConfig config) {
        this.config = config;
